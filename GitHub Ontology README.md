...
1. Open `CULTURAL HERITAGE MUSEUM ONTOLOGY.owl` in **Protégé**.
2. Start a reasoner (e.g. **HermiT** or **Pellet**) via *Reasoner → Start reasoner*.
3. The ontology classifies consistently; you can inspect inferred types and explore the individuals in the *Individuals* tab.
